...
import { Card, Icon, Rating, Input, Tile } from 'react-native-elements';
    ...
    const renderCommentItem = ({item}) => {
        return(
            <View style={{margin: 10}}>
                ...
                <Rating style={{alignItems: 'flex-start', paddingVertical: '5%'}}  imageSize={10} readonly startingValue={item.rating} ></Rating>
